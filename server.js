 ...
 * serves the static site and relays the app's own requests to api.aivoropro.com from
...
const UPSTREAM = "https://api.aivoropro.com";
...
function rewriteJson(obj) {
  if (typeof obj === "string") {
    if (obj.startsWith("https://api.aivoropro.com/")) return "/api/" + obj.slice("https://api.aivoropro.com/".length);
    return obj;
  }
