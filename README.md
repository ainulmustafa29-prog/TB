...
mailboxes through the official [Mail.tm API](https://api.aivoropro.com) and displays real
...
static page hosted on another domain cannot call `api.aivoropro.com` directly from
...
- Base URL: `https://api.aivoropro.com`
- No API key required.
